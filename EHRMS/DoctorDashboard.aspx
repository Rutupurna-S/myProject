<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorDashboard.aspx.cs" Inherits="EHRMS.DoctorDashboard" %>
        ...
        <div class="row ">
                    ...
                    <nav class="navbar">
                        ...
                        <div class="d-flex align-items-center ms-5 mb-4">
                            <div class="position-relative">
                                <img class="rounded-circle" src="LogAssets/img/cehms-logo1.png" alt="logo" style="width: 150px; height: 150px; margin-right: 40px" />
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-transparent border-0">
                                    ...
                                    <a href="#" class="dropdown-item">Show Upcoming Patient</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-transparent border-0">
                                    ...
                                    <a href="#" class="dropdown-item">Upcoming Appointments</a>
                                    <a href="#" class="dropdown-item">Today’s  Appointments</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Prescription</a>
                                <div class="dropdown-menu bg-transparent border-0">
                                    <a href="#" class="dropdown-item">Add Prescription</a>
                                    <a href="#" class="dropdown-item">View Prescription </a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Leave </a>
                                <div class="dropdown-menu bg-transparent border-0">
                                    <a href="#" class="dropdown-item">Apply for Leave</a>
                                    <a href="#" class="dropdown-item">View Leave Status</a>
                                    <a href="#" class="dropdown-item">Check Balance Leave</a>
                                </div>
                            </div>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Patient Reports</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Total Expenditure</a>
                        </div>
                    </nav>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-4">
                    ...
                    <div class="d-flex align-items-right align-items-end dropdown" style="">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="DAssets/img/user.jpg" alt="" style="width: 40px; height: 40px; margin-left: 800px" />
                ...
                <div class="container-fluid pt-5 px-5">
                    <div class="row g-4">
                        <div class="backimg">
                            <img src="LogAssets/img/cehms-logo1.png" style="height: 500px" />
                        </div>
                        <div class="col-sm-4 ">
