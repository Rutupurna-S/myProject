                            ...
                            <div class="row g-0">
                                <div class="card-body p-md-5 mx-md-4">
                                    <form class="form-inline login-content" runat="server">
                                        ...
                                        <asp:GridView ID="gridUser" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered" AllowPaging="true" PageSize="2" OnPageIndexChanging="gridUser_PageIndexChanging">
                                            <Columns>
                                        ...
                                        <asp:TextBox ID="txtTime" runat="server" Visible="false" TextMode="Time" placeholder="Time"></asp:TextBox>
                                        <asp:TextBox ID="txtDate" runat="server" Visible="false" TextMode="Date" placeholder="Date"></asp:TextBox>
