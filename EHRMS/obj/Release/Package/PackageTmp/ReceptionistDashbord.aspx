<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceptionistDashbord.aspx.cs" Inherits="EHRMS.ReceptionistDashbord" %>
                    ...
                    <nav class="navbar">
                       ...
                       <br />
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <a href="#" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i>Upcoming  Appointment</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Patient History</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Available Doctor</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i>Bills and Payments</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Book Appointments</a>
                            <a href="#" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Patient Registration</a>
                        </div>
                    </nav>
                </div>
            </div>
