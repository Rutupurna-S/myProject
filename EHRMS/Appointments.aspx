                        ...
                        <div class="card-body p-md-5 mx-md-4">
                            <form class="form-inline login-content" runat="server">
                                ...
                                <div class="form-outline mb-4">
                                    Select Hospital :
                                    <asp:DropDownList ID="ddlHospital" runat="server" Class="form-control" OnSelectedIndexChanged="Hospital_SelectedIndexChanged1" AutoPostBack="true"></asp:DropDownList>
                                </div>
                                <div class="form-outline mb-4">
                                    Select Department : 
                                    <asp:DropDownList ID="ddlDepartment" runat="server" class="form-control" OnSelectedIndexChanged="Department_SelectedIndexChanged1" AutoPostBack="true"></asp:DropDownList>
                                </div>
                                <div class="form-outline mb-4">
                                    Select Doctor :
                                    <asp:DropDownList ID="ddlDoctor" runat="server" class="form-control" OnSelectedIndexChanged="Doctor_SelectedIndexChanged1" AutoPostBack="true"></asp:DropDownList>
                                </div>
                                <div class="form-outline mb-4">
                                    Date :
                                    <asp:TextBox ID="txtDate" TextMode="Date" class="form-control" runat="server" AutoPostBack="true"></asp:TextBox>
                                </div>
                                <div class="form-outline mb-4">
                                    Time :
